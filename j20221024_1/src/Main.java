...
/*
  ...
  */
        ...
        TicketsStorage ticketsStorage= new TicketsStorage(1);
    ...
    public  static Ticket newTicket(){
        ...
        Ticket t=new Ticket(new Route("123","a","b",10),new MyDateTime(24,10,2022, 20,15),164);
        t.changeTime(26,10,2022,10,10);
        return t;
    }
